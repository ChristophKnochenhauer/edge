...
I have played around with next.js before, but can barely write proper Javascript.
...
We are currently in Chapter 10 out of 15 of the tutorial; click [here](https://nextjs.org/learn/dashboard-app/adding-search-and-pagination).
...
- [ ] Check out React Flow and alternatives.
Install and run a simple example from the documentation.
